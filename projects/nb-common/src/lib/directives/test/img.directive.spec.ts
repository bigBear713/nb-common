...
describe('Directive: Img', () => {
  ...
  describe('config the loadingImg and errImg via DI', () => {
    ...
    it('verify the loadingImg and errImg', inject([NbImgDirective], (imgDirective: NbImgDirective) => {
...
function onNbImgOnChange(imgDirective: NbImgDirective, change: { previousValue?: any, currentValue: any, firstChange?: boolean }): void {
...
class StandaloneComponent {
  ...
  @ViewChild(NbImgDirective)
  nbImg!: NbImgDirective;
  imgSrc = pictureLink;
}